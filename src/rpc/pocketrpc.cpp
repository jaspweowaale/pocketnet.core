...
static const CRPCCommand commands[] =
    {
        {"pocketnetrpc", "sendrawtransactionwithmessage", &sendrawtransactionwithmessage, {"hexstring", "message", "type"}},
        {"pocketnetrpc", "getrawtransactionwithmessage", &getrawtransactionwithmessage, {"address_from", "address_to", "start_txid", "count"}},
        {"pocketnetrpc", "getrawtransactionwithmessage2", &getrawtransactionwithmessage2, {"address_from", "address_to", "start_txid", "count"}},
        {"pocketnetrpc", "getrawtransactionwithmessagebyid", &getrawtransactionwithmessagebyid, {"txs", "address"}},
        {"pocketnetrpc", "getrawtransactionwithmessagebyid2", &getrawtransactionwithmessagebyid2, {"txs", "address"}},
        {"pocketnetrpc", "getuserprofile", &getuserprofile, {"addresses", "short"}},
        {"pocketnetrpc", "getmissedinfo", &getmissedinfo, {"address", "blocknumber"}},
        {"pocketnetrpc", "getmissedinfo2", &getmissedinfo2, {"address", "blocknumber"}},
        {"pocketnetrpc", "txunspent", &txunspent, {"addresses", "minconf", "maxconf", "include_unsafe", "query_options"}},
        {"pocketnetrpc", "getaddressregistration", &getaddressregistration, {"addresses"}},
        {"pocketnetrpc", "getuserstate", &getuserstate, {"address", "time"}},
        {"pocketnetrpc", "gettime", &gettime, {}},
        {"pocketnetrpc", "getrecommendedposts", &getrecommendedposts, {"address", "count"}},
        {"pocketnetrpc", "getrecommendedposts2", &getrecommendedposts2, {"address", "count"}},
        {"pocketnetrpc", "searchtags", &searchtags, {"search_string", "count"}},
        {"pocketnetrpc", "search", &search, {"search_string", "type", "count"}},
        {"pocketnetrpc", "search2", &search2, {"search_string", "type", "count"}},
        {"pocketnetrpc", "gethotposts", &gethotposts, {"count", "depth"}},
        {"pocketnetrpc", "gethotposts2", &gethotposts2, {"count", "depth"}},
        {"pocketnetrpc", "getuseraddress", &getuseraddress, {"name", "count"}},
        {"pocketnetrpc", "getreputations", &getreputations, {}},
        {"pocketnetrpc", "getcontents", &getcontents, {"address"}},
        {"pocketnetrpc", "gettags", &gettags, {"address", "count"}},
